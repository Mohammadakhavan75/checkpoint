var __dsPreview = (() => {
  ...
  // .design-sync/previews/TabBar.tsx
  var TabBar_exports = {};
  ...
  var frame = { background: "var(--ink)", padding: "20px 20px 0", borderRadius: "12px 12px 0 0", minWidth: 380 };
  function AppViews() {
  ...
  return __toCommonJS(TabBar_exports);
})();
